      ...
      for (const msg of messages) {
        try {
          ...
          if (groups[chatJid]) {
            ...
            // Voice messages get an exception: they carry no text but produce
            // a transcript below.
            ...
            // Voice notes carry no text; transcribe before delivery so the
            // agent receives the spoken content as readable text.

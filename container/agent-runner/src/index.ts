...
async function runQuery(
  ...
  // Files live under /workspace/group/attachments/ via the group folder mount;
  // we read them, base64-encode, and push as a separate user message before
  // the SDK starts streaming, so Claude sees them in the same turn as the prompt.
